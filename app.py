...
model = joblib.load('D:\\Bala DS\\Data science Class materials\\Projects\\P3_Carprice_Prediction\\Project Final\\Car_Price_Prediction_Model.pkl')
label_encoders = joblib.load('D:\\Bala DS\\Data science Class materials\\Projects\\P3_Carprice_Prediction\\Project Final\\Label_Encoders.pkl')
scalers = joblib.load('D:\\Bala DS\\Data science Class materials\\Projects\\P3_Carprice_Prediction\\Project Final\\Scalers.pkl')

# Load dataset for filtering and identifying similar data
data = pd.read_csv('D:\\Bala DS\\Data science Class materials\\Projects\\P3_Carprice_Prediction\\Project Final\\Car_Dekho_Cleaned_Dataset_Raw.csv')
...
st.markdown("<p style='text-align: center; font-size:14px; color:gray;'>Prediction Application Designed by <b>Balamurugan Arunachalam</b></p>", unsafe_allow_html=True)
